...
"""
Apollo 15 Lunar Flight Journals:

https://www.hq.nasa.gov/alsj/main.html

Apollo 15 Lunar Surface Journals:
...
def apollo15_lsj_scrape_index():
    """
    Scrape the index of the Apollo 15 Lunar Surface Journal.
    """
    ...
    print("Done scraping Apollo 15 Lunar Surface Journals.")


def apollo15_lfj_scrape_index():
    """
    Scrape the index of the Apollo 15 Lunar Flight Journal.
    ...
    print("Done scraping Apollo 15 Lunar Flight Journals.")




def apollo15_lsj_extract_dialogue():
    """
    ...
    lsj_files = glob.glob(os.path.join(SCRAPE_DIR,"a15*.html"))
    ...
    out_min = os.path.join(DATA_DIR,'apollo_15_sj_min.txt')
    out_nice = os.path.join(DATA_DIR,'apollo_15_sj.json')
    ...
    print("Done tokenizing Apollo 15 Lunar Surface Journals.")
...
def apollo15_lfj_extract_dialogue():
    ...
    out_min = os.path.join(DATA_DIR,'apollo_15_min.txt')
    out_nice = os.path.join(DATA_DIR,'apollo_15.json')
    ...
    print("Done tokenizing Apollo 15 Lunar Flight Journals.")
