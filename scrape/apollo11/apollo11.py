...
"""
Apollo 11 Lunar Flight Journals:
...
def apollo11_lsj_scrape_index():
    """
    Scrape the index of the Apollo 11 Lunar Surface Journal.
    """
    lsj_base_link = 'https://www.hq.nasa.gov/alsj/a11/'
    lsj_base_page = lsj_base_link+'a11.html'
    ...
    print("Done scraping Apollo 11 Lunar Surface Journals.")


def apollo11_lfj_scrape_index():
    """
    Scrape the index of the Apollo 11 Lunar Flight Journal.
    ...
    """
    lfj_base_link = 'https://web.archive.org/web/20171225232134/https://history.nasa.gov/afj/ap11fj/'
    ...
    print("Done scraping Apollo 11 Lunar Flight Journals.")




def apollo11_lsj_extract_dialogue():
    """
    ...
    lsj_files = glob.glob(os.path.join(SCRAPE_DIR,"a11*.html"))
    ...
    out_min = os.path.join(DATA_DIR,'apollo_11_sj_min.txt')
    out_nice = os.path.join(DATA_DIR,'apollo_11_sj.json')
    ...
    print("Done tokenizing Apollo 11 Lunar Surface Journals.")




def apollo11_lfj_extract_dialogue():
    """
    ...
    out_min = os.path.join(DATA_DIR,'apollo_11_min.txt')
    out_nice = os.path.join(DATA_DIR,'apollo_11.json')
    ...
    print("Done tokenizing Apollo 11 Lunar Flight Journals.")
...
if __name__=="__main__":
    ...
    apollo11_lsj_scrape_index()
    apollo11_lsj_extract_dialogue()
