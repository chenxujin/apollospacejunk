...
"""
Apollo 17 Lunar Flight Journals:

https://www.hq.nasa.gov/alsj/main.html

Apollo 17 Lunar Surface Journals:
...
def apollo17_lsj_scrape_index():
    """
    Scrape the index of the Apollo 17 Lunar Surface Journal.
    """
    lsj_base_link = 'https://www.hq.nasa.gov/alsj/a17/'
    lsj_base_page = lsj_base_link+'a17.html'
    ...
    print("Done scraping Apollo 17 Lunar Surface Journals.")


def apollo17_lfj_scrape_index():
    """
    Scrape the index of the Apollo 17 Lunar Flight Journal.
    ...
    """
    lfj_base_link = 'https://web.archive.org/web/20171225232125/https://history.nasa.gov/afj/ap17fj/'
    ...
    print("Done scraping Apollo 17 Lunar Flight Journals.")




def apollo17_lsj_extract_dialogue():
    """
    ...
    lsj_files = glob.glob(os.path.join(SCRAPE_DIR,"a17*.html"))
    ...
    out_min = os.path.join(DATA_DIR,'apollo_17_sj_min.txt')
    out_nice = os.path.join(DATA_DIR,'apollo_17_sj.json')
    ...
    print("Done tokenizing Apollo 17 Lunar Surface Journals.")




def apollo17_lfj_extract_dialogue():
    """
    ...
    out_min = os.path.join(DATA_DIR,'apollo_17_min.txt')
    out_nice = os.path.join(DATA_DIR,'apollo_17.json')
    ...
    print("Done tokenizing Apollo 17 Lunar Flight Journals.")
