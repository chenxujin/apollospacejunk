...
"""
Apollo 12 Lunar Flight Journals:

https://www.hq.nasa.gov/alsj/main.html

Apollo 12 Lunar Surface Journals:
...
def apollo12_lsj_scrape_index():
    """
    Scrape the index of the Apollo 12 Lunar Surface Journal.
    """
    lsj_base_link = 'https://www.hq.nasa.gov/alsj/a12/'
    lsj_base_page = lsj_base_link+'a12.html'
    ...
    print("Done scraping Apollo 12 Lunar Surface Journals.")


def apollo12_lfj_scrape_index():
    """
    Scrape the index of the Apollo 12 Lunar Flight Journal.
    ...
    """
    lfj_base_link = 'https://web.archive.org/web/20171225232127/https://history.nasa.gov/afj/ap12fj/'
    ...
    print("Done scraping Apollo 12 Lunar Flight Journals.")




def apollo12_lsj_extract_dialogue():
    """
    ...
    lsj_files = glob.glob(os.path.join(SCRAPE_DIR,"a12*.html"))
    ...
    out_min = os.path.join(DATA_DIR,'apollo_12_sj_min.txt')
    out_nice = os.path.join(DATA_DIR,'apollo_12_sj.json')
    ...
    print("Done tokenizing Apollo 12 Lunar Surface Journals.")




def apollo12_lfj_extract_dialogue():
    """
    ...
    out_min = os.path.join(DATA_DIR,'apollo_12_min.txt')
    out_nice = os.path.join(DATA_DIR,'apollo_12.json')
    ...
    print("Done tokenizing Apollo 12 Lunar Flight Journals.")
...
if __name__=="__main__":
    ...
    apollo12_lfj_scrape_index()
    apollo12_lfj_extract_dialogue()

    apollo12_lsj_scrape_index()
    apollo12_lsj_extract_dialogue()
